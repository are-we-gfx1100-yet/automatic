...
options_templates.update(options_section(('ui', "User Interface"), {
    ...
    "return_grid": OptionInfo(False, "Show grid in results for web"),
    ...
    "quicksettings_list": OptionInfo(["sd_model_checkpoint", "sd_vae", "sd_backend", "diffusers_pipeline", "sd_model_refiner"], "Quicksettings list", ui_components.DropdownMulti, lambda: {"choices": list(opts.data_labels.keys())}),
